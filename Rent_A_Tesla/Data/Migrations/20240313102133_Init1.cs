        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OurCarImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OurCars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OurCars_CarModel_CarId",
                        column: x => x.CarId,
                        principalTable: "CarModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OurCars_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarId = table.Column<int>(type: "int", nullable: false),
                    StartRes = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndRes = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservation_OurCars_CarId",
                        column: x => x.CarId,
                        principalTable: "OurCars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OurCars_CarId",
                table: "OurCars",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_OurCars_LocationId",
                table: "OurCars",
                column: "LocationId");
